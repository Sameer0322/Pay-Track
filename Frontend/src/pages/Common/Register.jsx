...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store only what you need in auth context
      login(data.user); // This will update context
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 overflow-hidden relative">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
          ...
          <p className="text-white mt-2">Create your employer account</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-white">
            ...
            <Link to="/login" className="text-accent hover:text-blue-600 font-medium">
              Sign in here
            </Link>
          </p>
          </div>
